                ...
                <el-col :span="2" class="order-menu">
                    <el-dropdown trigger="click" menu-align="start">
                        <span class="el-dropdown-link">
                            全部级别<i class="el-icon-caret-bottom el-icon--right"></i>
                        </span>
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item>全部级别</el-dropdown-item>
                            <el-dropdown-item>VIP会员</el-dropdown-item>
                            <el-dropdown-item>金牌会员</el-dropdown-item>
                            <el-dropdown-item>银牌会员</el-dropdown-item>
                            <el-dropdown-item>铜牌会员</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </el-col>
                <el-col :span="8">
                    <el-input placeholder="请输入客户名称/编码/订货账号/联系人/手机" icon="search" v-model="input2" :on-icon-click="handleIconClick">
                    </el-input>
                </el-col>
                <el-col :span="2">
