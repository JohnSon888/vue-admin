                ...
                <el-col :span="2" class="order-menu">
                    <el-dropdown trigger="click" menu-align="start">
                        <span class="el-dropdown-link">
                            全部收款账号<i class="el-icon-caret-bottom el-icon--right"></i>
                        </span>
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item>全部收款账号</el-dropdown-item>
                            <el-dropdown-item>支付宝流水号</el-dropdown-item>
                            <el-dropdown-item>微信流水号</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </el-col>
                <el-col :span="8">
                    <el-input placeholder="请输入客户名称/订单号/支付宝流水号" icon="search" v-model="input2" :on-icon-click="handleIconClick">
                    </el-input>
                </el-col>
                <el-col :span="2">
